...
describe('Compute', function() {
  ...
  describe('instantiation', function() {
    ...
    it('should return a new instance of Compute', function() {
      var compute = Compute({ projectId: PROJECT_ID });
  ...
  describe('createFirewall', function() {
    it('should make the correct API request', function(done) {
      ...
      compute.createFirewall(name, {}, util.noop);
    });

    it('should throw if a name is not provided', function() {
      assert.throws(function() {
        compute.createFirewall({}, util.noop);
    ...
    it('should format protocols', function(done) {
      ...
      compute.createFirewall('name', options, util.noop);
    });
    ...
    describe('error', function() {
      ...
      it('should return an error and the response', function(done) {
    ...
    describe('success', function() {
      ...
      it('should return a firewall and an operation', function(done) {
        var name = 'name';
        var firewall = {};
        var operation = {};
  ...
  describe('createNetwork', function() {
    it('should make the correct API request', function(done) {
      ...
      compute.createNetwork(name, {}, util.noop);
    });
    ...
    it('should set the IPv4Range', function(done) {
      ...
      compute.createNetwork('name', options, util.noop);
    });
    ...
    describe('error', function() {
      ...
      it('should return an error and the api response', function(done) {
    ...
    describe('success', function() {
      ...
      it('should return the network and an operation', function(done) {
        var network = {};
        var operation = {};
  ...
  describe('getAddresses', function() {
    it('should make the correct API request', function(done) {
      ...
      compute.getAddresses(options, util.noop);
    });
    ...
    it('should optionally accept options', function(done) {
      ...
      compute.getAddresses(util.noop);
    });
    ...
    describe('success', function() {
      ...
      it('should create addresses from the response', function(done) {
        var region = {};
  ...
  describe('getDisks', function() {
    it('should make the correct API request', function(done) {
      ...
      compute.getDisks(options, util.noop);
    });
    ...
    describe('success', function() {
      ...
      it('should create disks from the response', function(done) {
        var zone = {};
  ...
  describe('getFirewalls', function() {
    it('should make the correct API request', function(done) {
      ...
      compute.getFirewalls(options, util.noop);
    });
    ...
    it('should optionally accept options', function(done) {
      ...
      compute.getFirewalls(util.noop);
    });
    ...
    describe('success', function() {
      ...
      it('should create firewalls from the response', function(done) {
  ...
  describe('getNetworks', function() {
    it('should make the correct API request', function(done) {
      ...
      compute.getNetworks(options, util.noop);
    });
    ...
    describe('success', function() {
      ...
      it('should create networks from the response', function(done) {
  ...
  describe('getOperations', function() {
    it('should make the correct API request', function(done) {
      ...
      compute.getOperations(options, util.noop);
    });
    ...
    it('should optionally accept options', function(done) {
      ...
      compute.getOperations(util.noop);
    });
    ...
    describe('success', function() {
      ...
      it('should create operations from the response', function(done) {
  ...
  describe('getRegions', function() {
    it('should make the correct API request', function(done) {
      ...
      compute.getRegions(options, util.noop);
    });
    ...
    describe('success', function() {
      ...
      it('should create regions from the response', function(done) {
        compute.region = function(name) {
  ...
  describe('getSnapshots', function() {
    it('should make the correct API request', function(done) {
      ...
      compute.getSnapshots(options, util.noop);
    });
    ...
    it('should optionally accept options', function(done) {
      ...
      compute.getSnapshots(util.noop);
    });
    ...
    describe('success', function() {
      ...
      it('should create snapshots from the response', function(done) {
  ...
  describe('getVMs', function() {
    it('should make the correct API request', function(done) {
      ...
      compute.getVMs(options, util.noop);
    });
    ...
    describe('success', function() {
      ...
      it('should create vms from the response', function(done) {
        var zone = {};
  ...
  describe('getZones', function() {
    it('should make the correct API request', function(done) {
      ...
      compute.getZones(options, util.noop);
    });
